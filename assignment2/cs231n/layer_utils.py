...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
    """ [Affine - BN - ReLu] layer

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta: Scaling and shifting parameters for BN layer
    - bn_params: BN layer parameters
...
def affine_ln_relu_forward(x, w, b, gamma, beta, ln_param):
    """ [Affine - LN - ReLu] layer

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta: Scaling and shifting parameters for LN layer
    - ln_params: LN layer parameters
